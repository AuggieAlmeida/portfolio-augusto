        ...
        <div class="about-content grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10 items-stretch">
          ...
          >
            ...
            <div class="professional-highlight mb-8">
              <h3 class="text-xl md:text-2xl font-semibold text-primary-600 dark:text-primary-400 mb-4 flex items-center gap-2">
            ...
            <div class="expertise-section mb-8">
              <h3 class="text-xl md:text-2xl font-semibold text-secondary-600 dark:text-secondary-400 mb-4 flex items-center gap-2">
            ...
            <div class="contact-section">
              <h3 class="text-xl md:text-2xl font-semibold text-accent-600 dark:text-accent-400 mb-4 flex items-center gap-2">
                <i class="fas fa-envelope"></i>
                {{ 'about.contactInfo' | translate }}
              </h3>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="contact-item flex items-center gap-3 p-3 rounded-lg bg-primary-50 dark:bg-secondary-900/30 border border-primary-200 dark:border-primary-700">
                  <div class="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center">
                    <i class="fas fa-envelope text-white text-sm"></i>
                  </div>
                  <div>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">{{ 'about.email' | translate }}</p>
                    <a href="mailto:augusto.almeida2@icloud.com" class="text-primary-600 dark:text-primary-400 hover:underline font-medium">
                      augusto.almeida2&#64;icloud.com
                    </a>
                  </div>
                </div>

                <div class="contact-item flex items-center gap-3 p-3 rounded-lg bg-accent-50 dark:bg-secondary-900/30 border border-accent-200 dark:border-accent-700">
                  ...
                  <div>
                    ...
                    <a href="https://linkedin.com/in/augustobalmeida" target="_blank" rel="noopener noreferrer" class="text-secondary-600 dark:text-secondary-400 hover:underline font-medium">
                      /augustobalmeida
                    </a>
                  </div>
                </div>
                ...
                <div class="contact-item flex items-center gap-3 p-3 rounded-lg bg-accent-50 dark:bg-secondary-900/30 border border-accent-200 dark:border-accent-700">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/auggiealmeida" target="_blank" rel="noopener noreferrer" class="text-accent-600 dark:text-accent-400 hover:underline font-medium">
                      /auggiealmeida
                    </a>
                  </div>
                </div>

                <div class="contact-item flex items-center gap-3 p-3 rounded-lg bg-green-50 dark:bg-secondary-900/30 border border-green-200 dark:border-green-700">
                  <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center">
                    <i class="fab fa-whatsapp text-white text-sm"></i>
                  </div>
                  <div>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">WhatsApp</p>
                    <a href="https://wa.me/5511916047732" target="_blank" rel="noopener noreferrer" class="text-green-600 dark:text-green-400 hover:underline font-medium">
                      +55 (11) 91604-7732
                    </a>
                  </div>
                </div>
      ...
      if (element) {
        ...
        setTimeout(() => {
          ...
          if (text.trim()) {
            ...
            element.innerHTML = words.map((word: string, index: number) => 
